...
export default function RegisFormPage() {
  ...
  const registerBtnOnClick = () => {
    ...
    if (fnameOk && lanameOk && genderOk && planOk) {
      alert(
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div className="d-flex gap-2">
        <div>
          ...
          <input
            ...
            value={fname}
          />
          <div className="invalid-feedback" checked={fnameError}>
            Invalid first name
          </div>
        </div>
        <div>
          ...
          <input
            ...
            value={lname}
          />
          <div className="invalid-feedback" checked={lnameError}>
            Invalid last name
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="invalid-feedback" checked={planError}>
